...
---
Some test svg icons from FontAwesome 6 Pro.

Use the force as a powerful Jedi {{< icon jedi-light >}}. You need food to fight well. Have some pizza {{< icon pizza-slice-light >}}.
Ask the honey badger {{< icon badger-honey-duotone >}} about all this and he will say {{< icon badger-honey-thin >}}"Honey badger don't care". {{< icon badger-honey-light >}.
